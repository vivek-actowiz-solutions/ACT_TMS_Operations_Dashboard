        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto items-center">
          ...
          <div>
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold w-full sm:w-auto"
            >
              Feasible
            </button>
          </div>
          ...
          >
            <DataGrid
                  ...
                  renderCell: (params) => {
                    ...
                    const ActionIcon = ({ title, color, hoverColor, onClick, children }) => (
                      ...
                      >
                        <IconButton
                          size="small"
                          // ⭐ CLICK FIX: use mouseDown instead of click
                          onMouseDown={(e) => {
                            e.stopPropagation();
                            e.preventDefault(); // prevents DataGrid from focusing
                            onClick && onClick(e);
                          }}
                          sx={{
                            color,
                        ...
                        {(role === "Admin" || role === "Manager" || role === "SuperAdmin") &&
                          (
                            ...
                            <ActionIcon
                              ...
                              onClick={() =>
                                navigate(
                                  `/TMS-operations/edit/${taskId}?domain=${encodeURIComponent(domainName)}`
                                )
                              }
                            >
                              <FiEdit2 size={18} />
              ...
              sx={{
                ...
                "& .MuiDataGrid-cell:focus, & .MuiDataGrid - cell:focus-within,& .MuiDataGrid-cell:focus-within *": {
                  outline: "none !important",
